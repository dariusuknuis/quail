...
build-darwin: ## build darwin
	@CGO_ENABLED=0 GOOS=darwin GOARCH=amd64 go build -trimpath -buildmode=pie -ldflags="-X main.ShowVersion=1 -X main.Version=v1.7-d -s -w" -o bin/${NAME}-darwin

build-linux: ## build linux
	@CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -trimpath -ldflags="-X main.ShowVersion=1 -X main.Version=v1.7-d -s -w" -o bin/${NAME}-linux

build-windows: ## build windows
	@CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -trimpath -buildmode=pie -ldflags="-X main.ShowVersion=1 -X main.Version=v1.7-d -s -w" -o bin/${NAME}.exe

build-windows-addon: ## build windows blender addon
	@CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -trimpath -buildmode=pie -ldflags="-X main.ShowVersion=1 -X main.Version=v1.7-d -s -w" -o bin/${NAME}-addon.exe
